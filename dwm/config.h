...
static const char col_cyan[]        = "#a1932a";
static const char col_borderbar[]   = "#a1932a";
...
static const char *tags[] = { "term", "web", "code", "misc" };
...
static const char *termcmd[]  = { "st", "-e", "ksh", "-l", NULL };
